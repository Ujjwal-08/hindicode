...
const tests = [
    ...
    {
        name: "supports for...of and newer array, object, string, and number helpers",
        async run() {
            const { result } = await executeHindi(`
                नया कुल = 0;
                ...
                लौटाओ {
                    कुल,
                    चपटा: सूची.समतल(2),
                    दोगुना: [1, 2].समतल_मानचित्र((x) => [x, x * 2]),
                    आखिरी: [5, 6, 7].स्थान_पर(-1),
                    कुछ: [1, 5].कुछ_है((x) => x बड़ा 3),
                    सब: [1, 5].सभी_हैं((x) => x बड़ा 3),
                    वस्तु: ऑब्जेक्ट.प्रविष्टियों_से([["क", 1]]),
                    अपना: ऑब्जेक्ट.अपना_है({ क: 1 }, "क"),
                    भरा: "7".बाएँ_भरो(3, "0") + "|" + "7".दाएँ_भरो(3, "-"),
                    मिला: "abc123".मिलान(/\\d+/)[0],
                    पूर्णांक: पूर्णांक_बनाओ("42px"),
                    दशमलव: दशमलव_बनाओ("3.5"),
                    अमान्य: नंबर.संख्या_नहीं(NaN),
                    परिमित: नंबर.परिमित_है(10),
                };
            `, { parseInt, parseFloat });
    ...
    {
        name: "supports Promise.race / allSettled and newer built-ins",
        async run() {
            const { result } = await executeHindi(`
                स्थिर पहला = इंतज़ार प्रॉमिस.दौड़([प्रॉमिस.हल("तेज़"), नया_बनाओ_देर()]);
                कार्य नया_बनाओ_देर() { लौटाओ नया बनाओ प्रॉमिस((हल_करो) => समय_बाद(() => हल_करो("धीमा"), 20)); }
                स्थिर नतीजे = इंतज़ार प्रॉमिस.सब_निपटे([प्रॉमिस.हल(1), प्रॉमिस.अस्वीकार(नया बनाओ त्रुटि("x"))]);
                स्थिर कैश = नया बनाओ कमज़ोर_नक्शा();
                स्थिर कुंजी = {};
                कैश.रखो(कुंजी, 1);
                स्थिर पता = नया बनाओ यूआरएल("https://example.com/a?x=1");
                लौटाओ {
                    पहला,
                    स्थितियाँ: नतीजे.मानचित्र((n) => n.status),
                    कैश: कैश.है(कुंजी),
                    प्रतीक_प्रकार: typeof प्रतीक("id"),
                    विशाल: (बड़ा_पूर्णांक(2) ** 64n).toString(),
                    मार्ग: पता.pathname,
                    परम: नया बनाओ यूआरएल_पैरामीटर("a=1&b=2").get("b"),
                    रद्द: नया बनाओ रद्द_नियंत्रक().signal.aborted,
                };
            `, { WeakMap, Symbol, BigInt, URL, URLSearchParams, AbortController });

            assert.deepEqual(normalize(result), {
                पहला: "तेज़",
                स्थितियाँ: ["fulfilled", "rejected"],
                कैश: true,
                प्रतीक_प्रकार: "symbol",
                विशाल: "18446744073709551616",
                मार्ग: "/a",
                परम: "2",
                रद्द: false,
            });
